...
import { canManageBusinessData } from '../utils/permissions'

export default function Dashboard() {
  const navigate = useNavigate()
  const canManage = canManageBusinessData(authService.getUser())
        ...
        <div className="xl:col-span-2">
          {canManage ? (
            ...
            <Card title="Recent Payments">
              <p className="text-sm text-gray-500 text-center py-8">Recent payments are unavailable.</p>
            </Card>
          )}
        </div>
